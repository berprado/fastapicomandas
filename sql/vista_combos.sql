...
SELECT 
    ...
    SUBSTRING_INDEX(combo.descripcion, ' ', 1) AS unidad_venta, -- solo la primera palabra
    combo.descripcion AS descripcion_combo,                     -- descripción completa
...
WHERE det.estado = 'HAB' AND combo.estado = 'HAB';